...
// import '../models/boom_angle_model.dart';
// import '../models/boom_angle_service_interface.dart';
// import '../models/service_data.dart';
// import '../models/provider_data.dart';
// import '../services/service_wrapper_interface.dart';
// import '../enums.dart';

// class BoomAngleProvider {
//   IBoomAngleService _currentService;

//   ServiceList _serviceList;
//   StreamController<BoomAngleModel> _stream = StreamController();
...
//   ProviderData _providerData = ProviderData(ProviderType.boom_angle, 'manual');
//   StreamController<ProviderData> _providerDataStream = StreamController();

//   BoomAngleProvider(ServiceList serviceList) {
...
//   StreamController<BoomAngleModel> get boomAngle => this._stream;
