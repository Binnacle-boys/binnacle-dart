...
import 'package:sos/ui/ideal_heading_widget.dart';
import 'package:sos/ui/heading_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Center(
          ...
          Expanded(flex: 6, child: new Stack(children: <Widget>[Binnacle(), ListAngleUI(), BoomUI(), HeadingUI()])),
          Expanded(
            flex: 3,
            child: Container(
