        ...
        body: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: <Widget>[
          Expanded(
              ...
              child: Column(children: <Widget>[
                Expanded(flex: 5, child: boatSpeedLabel(positionStream: bloc.position)),
                Expanded(
                  flex: 5,
          ...
          Expanded(
              flex: 5,
              child: Container(
                  decoration: new BoxDecoration(border: new Border(left: new BorderSide(color: theme.backgroundColor))),
